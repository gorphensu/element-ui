	...
	exports.default = {
	      ...
	      if (!this.columnWidth) {
	        if (this.data.length > _config.optimizeConfig.defaultVisibleRowSize) {
	          this.data.slice(0, _config.optimizeConfig.defaultVisibleRowSize).forEach(function (row) {
	            _this.store.commit('addLoadedRow', row);
	          });
	        }
	      } else {}
	    }
	  ...
	  render: function render(h) {
	    ...
	    return h(
	      ...
	      [h(
	        'div',
	        { style: [{ transform: 'translateY(' + this.innerTop + 'px)' }] },
	        [h(
	          'table',
	          {
	            'class': 'el-table__body',
	          ...
	          [h(
	            ...
	            [this._l(this.visibleData, function (row, $index) {
	              return [h(
	                'tr',
	                {
	                  style: [_this2.rowStyle ? _this2.getRowStyle(row, $index) : null, _this2.trRowHeightStyle],
	                  key: _this2.table.rowKey ? _this2.getKeyOfRow(row, $index) : $index,
	                  on: {
	                    'dblclick': function dblclick($event) {
	                  ...
	                  'class': [_this2.getRowClass(row, $index)] },
	                [_this2._l(tmpFixedColumns, function (column, cellIndex) {
	                  ...
	                  return h(
	                    ...
	                    [column.renderCell.call(_this2._renderProxy, h, { row: row, column: column, $index: $index, store: _this2.store, _self: _this2.context || _this2.table.$vnode.context }, columnsHidden[cellIndex])]
	                  );
	  ...
	  computed: (_computed = {
	    visibleData: function visibleData() {
	      if (this.table.optimizeY && this.rowHeight && this.columnWidth) {
	  ...
	  methods: {
	    ...
	    scrollEvent2: function scrollEvent2(e) {
	      ...
	      if (bodyWrapper) {
	        ...
	        var end = start + this.visibleCount;
