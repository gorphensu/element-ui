...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  created: function created() {
	    this.debounceTriggerEvent = (0, _debounce2.default)(20, this.triggerEvent);
	    this.bindEvent();
	  },
	  mounted: function mounted() {
	    this.debounceTriggerEvent();
	  ...
	  methods: {
	    triggerEvent: function triggerEvent() {
	      ...
	      this.$nextTick(function () {
	        _this.parent.table.$emit('table-row-resize-change-' + _this.index, _this.$el);
	      });
	    },
	    bindEvent: function bindEvent() {
	      ...
	      this.parent.table.$on('table-row-resize-change-' + this.index, function ($el) {
	        _this2.$nextTick(function () {
	          ...
	          var currentHeight = _this2.$el.offsetHeight;
	          if ($el.offsetHeight > currentHeight) {
	            _this2.$el.style['height'] = $el.offsetHeight + 'px';
	            // 修复如果滚动条不在最初状态，修复高度后，滚动条需要保存位置
	            if (_this2.parent.table.$refs.fixedBodyWrapper) {
	              if (_this2.parent.table.$refs.fixedBodyWrapper.scrollTop !== _this2.parent.table.bodyWrapper.scrollTop) {
	                _this2.parent.table.$refs.fixedBodyWrapper.scrollTop = _this2.parent.table.bodyWrapper.scrollTop;
	              }
	            }
	            if (_this2.parent.table.$refs.rightFixedBodyWrapper) {
	              if (_this2.parent.table.$refs.rightFixedBodyWrapper.scrollTop !== _this2.parent.table.bodyWrapper.scrollTop) {
	                _this2.parent.table.$refs.rightFixedBodyWrapper.scrollTop = _this2.parent.table.bodyWrapper.scrollTop;
	              }
	            }
	          }
	        });
	      ...
	      this.parent.table.$on('header-dragend', function () {
	        _this2.$el.style['height'] = '';
	        _this2.debounceTriggerEvent();
	      });
	    },
